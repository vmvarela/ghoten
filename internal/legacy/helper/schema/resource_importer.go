...
// ResourceImporter defines how a resource is imported in Ghoten. This
...
//
// "Importing" in Ghoten is the process of taking an already-created
// resource and bringing it under Ghoten management. This can include
// updating Ghoten state, generating Ghoten configuration, etc.
type ResourceImporter struct {
	...
	// insert into the Ghoten state. If this isn't specified, then
	// the ID is passed straight through.
	State StateFunc
}

// StateFunc is the function called to import a resource into the
// Ghoten state. It is given a ResourceData with only ID set. This
