...
// Resource represents a thing in Ghoten that has a set of configurable
...
type Resource struct {
	...
	// called specifically by Ghoten when the stored schema version is less
	// than the current SchemaVersion of the Resource.
	//
	...
	// Ghoten has created for this resource - it can be used to customize the
	...
	//
	// The phases Ghoten runs this in, and the state available via functions
...
// ghoten.InstanceState.
func (r *Resource) ShimInstanceStateFromValue(state cty.Value) (*ghoten.InstanceState, error) {
	// Get the raw shimmed value. While this is correct, the set hashes don't
	// match those from the Schema.
	s := ghoten.NewInstanceStateShimmedFromValue(state, r.SchemaVersion)
...
type StateMigrateFunc func(
	int, *ghoten.InstanceState, interface{}) (*ghoten.InstanceState, error)
...
func (r *Resource) Apply(
	...
	meta interface{}) (*ghoten.InstanceState, error) {
	...
	if s == nil {
		// The Ghoten API dictates that this should never happen, but
		// it doesn't hurt to be safe in this case.
		s = new(ghoten.InstanceState)
	}
...
func (r *Resource) Diff(
	s *ghoten.InstanceState,
	c *ghoten.ResourceConfig,
	meta interface{}) (*ghoten.InstanceDiff, error) {
...
func (r *Resource) simpleDiff(
	...
	if instanceDiff == nil {
		instanceDiff = ghoten.NewInstanceDiff()
	}
...
func (r *Resource) Validate(c *ghoten.ResourceConfig) ([]string, []error) {
...
func (r *Resource) upgradeState(s *ghoten.InstanceState, meta interface{}) (*ghoten.InstanceState, error) {
	var err error
...
func (r *Resource) Data(s *ghoten.InstanceState) *ResourceData {
...
func (r *Resource) checkSchemaVersion(is *ghoten.InstanceState) (bool, int) {
...
func (r *Resource) recordCurrentSchemaVersion(
	state *ghoten.InstanceState) *ghoten.InstanceState {
