...
func testApplyDiff(t *testing.T,
	resource *Resource,
	state, expected *ghoten.InstanceState,
...
func TestShimResourceApply_create(t *testing.T) {
	...
	var s *ghoten.InstanceState = nil
	...
	createdState := &ghoten.InstanceState{
		ID:         "foo",
...
func TestShimResourceDiff_Timeout_diff(t *testing.T) {
	...
	conf := ghoten.NewResourceConfigRaw(map[string]interface{}{
		"foo": 42,
		TimeoutsConfigKey: map[string]interface{}{
			"create": "2h",
		},
	})
	var s *ghoten.InstanceState
...
func TestShimResourceApply_destroyCreate(t *testing.T) {
	...
	var s *ghoten.InstanceState = &ghoten.InstanceState{
		ID: "bar",
		Attributes: map[string]string{
			"foo":       "7",
			"tags.Name": "foo",
	...
	d := &ghoten.InstanceDiff{
		Attributes: map[string]*ghoten.ResourceAttrDiff{
			...
			"tags.Name": &ghoten.ResourceAttrDiff{
				Old:         "foo",
				New:         "foo",
				RequiresNew: true,
			},
