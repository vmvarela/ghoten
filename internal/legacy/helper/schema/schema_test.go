...
import (
	...
	"github.com/vmvarela/ghoten/internal/legacy/hcl2shim"
	"github.com/vmvarela/ghoten/internal/legacy/helper/hashcode"
...
func TestSchemaMap_Diff(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"availability_zone": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         "foo",
						RequiresNew: true,
					},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"ports.#": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "3",
					},
					"ports.0": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"ports.1": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "2",
					},
					"ports.2": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "5",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"config.#": &ghoten.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},

					"config.0.name": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "hello",
					},

					"config.0.rules.#": &ghoten.ResourceAttrDiff{
						Old:         "",
						NewComputed: true,
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"ports.5": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "5",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"ingress.#": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"ingress.0.from": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "8080",
					},
				},
		...
		*/

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"config_vars.%": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},

					"config_vars.bar": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"config_vars.foo": &ghoten.ResourceAttrDiff{
						Old:        "bar",
						NewRemoved: true,
					},
					"config_vars.bar": &ghoten.ResourceAttrDiff{
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"vars.foo": &ghoten.ResourceAttrDiff{
						Old:        "bar",
						New:        "",
						NewRemoved: true,
					},
					"vars.bar": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"config_vars.0.foo": &ghoten.ResourceAttrDiff{
						Old:        "bar",
						NewRemoved: true,
					},
					"config_vars.0.bar": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"config_vars.0.%": &ghoten.ResourceAttrDiff{
						Old: "2",
						New: "0",
					},
					"config_vars.0.foo": &ghoten.ResourceAttrDiff{
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"address": &ghoten.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						NewComputed: true,
					},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"instances.#": &ghoten.ResourceAttrDiff{
						NewComputed: true,
					},
				},
			},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"route.#": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"route.~1.index": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"route.~1.gateway": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"some_threshold": &ghoten.ResourceAttrDiff{
						Old: "567.8",
						New: "12.34",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"instances.3": &ghoten.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						NewRemoved:  true,
						RequiresNew: true,
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"route.1.gateway-name": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "hello",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"service_account.#": &ghoten.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},
					"service_account.0.scopes.#": &ghoten.ResourceAttrDiff{
						Old:         "0",
						New:         "1",
						RequiresNew: true,
					},
					"service_account.0.scopes.123": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         "123!",
						NewExtra:    "123",
						RequiresNew: true,
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"instances.2": &ghoten.ResourceAttrDiff{
						Old:         "22",
						New:         "",
						NewRemoved:  true,
						RequiresNew: true,
					...
					"instances.4": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         "4444",
						RequiresNew: true,
					},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"one": &ghoten.ResourceAttrDiff{
						Old: "false",
						New: "true",
					},
					"two": &ghoten.ResourceAttrDiff{
						Old: "true",
						New: "false",
					},
					"three": &ghoten.ResourceAttrDiff{
						Old:        "true",
						New:        "false",
						NewRemoved: true,
					},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"ports.4": &ghoten.ResourceAttrDiff{
						Old:         "4",
						New:         "0",
						NewRemoved:  true,
						RequiresNew: true,
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"description": &ghoten.ResourceAttrDiff{
						Old:         "foo",
						New:         "",
						RequiresNew: true,
						NewRemoved:  true,
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"ami_id": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "foo",
					},
					"instance_id": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "bar",
					},
				},
...

		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"etag": &ghoten.ResourceAttrDiff{
						Old: "foo",
						New: "bar",
					},
					"version_id": &ghoten.ResourceAttrDiff{
						Old:         "1",
						New:         "",
						NewComputed: true,
					},
	...
	for i, tc := range cases {
		t.Run(fmt.Sprintf("%d-%s", i, tc.Name), func(t *testing.T) {
			c := ghoten.NewResourceConfigRaw(tc.Config)
...
func TestSchemaMap_Input(t *testing.T) {
	...
	for i, tc := range cases {
		...
		input := new(ghoten.MockUIInput)
		input.InputReturnMap = tc.Input

		rc := ghoten.NewResourceConfigRaw(tc.Config)
...
func TestSchemaMap_InputDefault(t *testing.T) {
	...
	rc := ghoten.NewResourceConfigRaw(emptyConfig)
	rc.Config = make(map[string]interface{})

	input := new(ghoten.MockUIInput)
	input.InputFn = func(opts *ghoten.InputOpts) (string, error) {
...
func TestSchemaMap_DiffSuppress(t *testing.T) {
	cases := map[string]struct {
		...
		State        *ghoten.InstanceState
		Config       map[string]interface{}
		ExpectedDiff *ghoten.InstanceDiff
		Err          bool
	}{
		...
		"Complex structure with set of computed string should mark root set as computed": {
			...
			ExpectedDiff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"outer.#": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"outer.~1.outer_str": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "foo",
					},
					"outer.~1.inner.#": &ghoten.ResourceAttrDiff{
						Old: "0",
						New: "1",
					},
					"outer.~1.inner.~2.inner_str": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
		...
		"Complex structure with complex list of computed string should mark root set as computed": {
			...
			ExpectedDiff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"outer.~1.inner.0.inner_str": &ghoten.ResourceAttrDiff{
						Old:         "",
						New:         hcl2shim.UnknownVariableValue,
						NewComputed: true,
					},
