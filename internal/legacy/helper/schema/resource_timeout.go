...
func (t *ResourceTimeout) ConfigDecode(s *Resource, c *ghoten.ResourceConfig) error {
	if s.Timeouts != nil {
...
// saving to state
func (t *ResourceTimeout) DiffEncode(id *ghoten.InstanceDiff) error {
	return t.metaEncode(id)
}

func (t *ResourceTimeout) StateEncode(is *ghoten.InstanceState) error {
...
// Assumes the interface is either *ghoten.InstanceState or
// *ghoten.InstanceDiff, returns an error otherwise
...
func (t *ResourceTimeout) StateDecode(id *ghoten.InstanceState) error {
	return t.metaDecode(id)
}
func (t *ResourceTimeout) DiffDecode(is *ghoten.InstanceDiff) error {
