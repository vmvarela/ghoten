...
func TestResourceDataGet(t *testing.T) {
	cases := []struct {
		...
		// #14 List of maps
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"config_vars.1.bar": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
		...
		// #18
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"data.10.value": &ghoten.ResourceAttrDiff{
						Old: "50",
						New: "80",
					},
				},
		...
		// #23 Sets with removed elements
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"ports.80": &ghoten.ResourceAttrDiff{
						Old: "80",
						New: "80",
					},
					"ports.8080": &ghoten.ResourceAttrDiff{
						Old:        "8080",
						New:        "0",
						NewRemoved: true,
					},
...
func TestResourceDataGetOk(t *testing.T) {
	cases := []struct {
		...
		// indistinguishable from unset config.
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"from_port": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "0",
					},
				},
...
func TestResourceDataHasChange(t *testing.T) {
	cases := []struct {
		...
		// https://github.com/hashicorp/terraform/issues/927
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"tags.foo": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "bar",
					},
				},
...
func TestResourceDataState_schema(t *testing.T) {
	cases := []struct {
		...
		// #5 List of resources
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					...
					"ingress.1.from": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "100",
					},
				},
		...
		// #17 Sets
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"ports.120": &ghoten.ResourceAttrDiff{
						New: "120",
					},
				},
			},
		...
		// #23 Set of maps
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"ports.10.uuids.#": &ghoten.ResourceAttrDiff{
						NewComputed: true,
					},
				},
			},
...
func TestResourceData_nonStringValuesInMap(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"boolMap.%": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"boolMap.boolField": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "true",
					},
				},
		...
		},
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"intMap.%": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"intMap.intField": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "8",
					},
				},
		...
		},
		{
			...
			Diff: &ghoten.InstanceDiff{
				Attributes: map[string]*ghoten.ResourceAttrDiff{
					"floatMap.%": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"floatMap.floatField": &ghoten.ResourceAttrDiff{
						Old: "",
						New: "8.22",
					},
				},
...
func TestResourceDataSetId_clear(t *testing.T) {
	d := &ResourceData{
		state: &ghoten.InstanceState{ID: "bar"},
	}
	d.SetId("")
