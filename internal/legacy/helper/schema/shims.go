...
// derives a ghoten.InstanceDiff to give to the legacy providers. This is
...
func DiffFromValues(prior, planned cty.Value, res *Resource) (*ghoten.InstanceDiff, error) {
...
func diffFromValues(prior, planned cty.Value, res *Resource, cust CustomizeDiffFunc) (*ghoten.InstanceDiff, error) {
	...
	cfg := ghoten.NewResourceConfigShimmed(planned, configSchema)
...
// ApplyDiff takes a cty.Value state and applies a ghoten.InstanceDiff to
...
func ApplyDiff(base cty.Value, d *ghoten.InstanceDiff, schema *configschema.Block) (cty.Value, error) {
...
// StateValueFromInstanceState converts a ghoten.InstanceState to a
// cty.Value as described by the provided cty.Type, and maintains the resource
// ID as the "id" attribute.
func StateValueFromInstanceState(is *ghoten.InstanceState, ty cty.Type) (cty.Value, error) {
