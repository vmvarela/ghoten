...
// the external program as an external keyprovider for Ghoten.
const HeaderMagic = "Ghoten-External-Key-Provider"

// Header describes the initial header the external program must output as a single line,
// followed by a single newline.
type Header struct {
	// Magic must always be "Ghoten-External-Key-Provider".
