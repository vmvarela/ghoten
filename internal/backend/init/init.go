...
import (
	...
	backendRemote "github.com/vmvarela/ghoten/internal/backend/remote"
	backendAzure "github.com/vmvarela/ghoten/internal/backend/remote-state/azure"
	backendConsul "github.com/vmvarela/ghoten/internal/backend/remote-state/consul"
	backendCos "github.com/vmvarela/ghoten/internal/backend/remote-state/cos"
	backendGCS "github.com/vmvarela/ghoten/internal/backend/remote-state/gcs"
	backendHTTP "github.com/vmvarela/ghoten/internal/backend/remote-state/http"
	backendInmem "github.com/vmvarela/ghoten/internal/backend/remote-state/inmem"
	backendKubernetes "github.com/vmvarela/ghoten/internal/backend/remote-state/kubernetes"
	backendORAS "github.com/vmvarela/ghoten/internal/backend/remote-state/oras"
	backendOSS "github.com/vmvarela/ghoten/internal/backend/remote-state/oss"
	backendPg "github.com/vmvarela/ghoten/internal/backend/remote-state/pg"
	backendS3 "github.com/vmvarela/ghoten/internal/backend/remote-state/s3"
	backendCloud "github.com/vmvarela/ghoten/internal/cloud"
...
func Init(services *disco.Disco) {
	...
	RemovedBackends = map[string]string{
		"artifactory": `The "artifactory" backend is not supported in Ghoten v1.3 or later.`,
		"azure":       `The "azure" backend name has been removed, please use "azurerm".`,
		"etcd":        `The "etcd" backend is not supported in Ghoten v1.3 or later.`,
		"etcdv3":      `The "etcdv3" backend is not supported in Ghoten v1.3 or later.`,
		"manta":       `The "manta" backend is not supported in Ghoten v1.3 or later.`,
		"swift":       `The "swift" backend is not supported in Ghoten v1.3 or later.`,
	}
}
