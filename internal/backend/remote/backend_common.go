...
func (b *Remote) hasExplicitVariableValues(ctx context.Context, op *backend.Operation) bool {
	...
	for _, v := range variables {
		switch v.SourceType {
		case ghoten.ValueFromCLIArg, ghoten.ValueFromNamedFile:
			return true
		}
	}
...
func (b *Remote) confirm(stopCtx context.Context, op *backend.Operation, opts *ghoten.InputOpts, r *tfe.Run, keyword string) error {
