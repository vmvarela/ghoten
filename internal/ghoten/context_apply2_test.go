...
// TestContext2Apply_sensitiveInsideUnknown verifies that Ghoten uses
...
//
// For additional context, refer to https://github.com/vmvarela/ghoten/issues/3367 .
...
func TestContext2Apply_resourceConditionApplyTimeFail(t *testing.T) {
	...
	//
	// This edge case is a tricky one because it relies on Ghoten still
...
func TestContext2Apply_providerExpandWithTargetOrExclude(t *testing.T) {
	...
	// cause Ghoten to skip visiting certain objects.
	//
	...
	// each test.
	// For correct operation the plan options must cause Ghoten to
	...
	runTest := func(t *testing.T, makeStep2PlanOpts func(plans.Mode) *PlanOpts) {
		...
		// to how Ghoten CLI would do it, in case its normalization rules and
...
// be executed.
// This test has been added when a fix for https://github.com/vmvarela/ghoten/issues/3489
// was provided.
