...
import (
	...
	"github.com/vmvarela/ghoten/internal/communicator/shared"
...
func (n *NodeValidatableResource) validateResource(ctx context.Context, evalCtx EvalContext) tfdiags.Diagnostics {
	...
	// Ghoten team, so we're going to defer that solution for a future
