...
// and overrides for that one specific resource instance, any other usage is a bug in Ghoten and should
// be corrected.
...
func (p providerForTest) PlanResourceChange(_ context.Context, r providers.PlanResourceChangeRequest) providers.PlanResourceChangeResponse {
	...
	// later on. This resolves https://github.com/vmvarela/ghoten/issues/3644
