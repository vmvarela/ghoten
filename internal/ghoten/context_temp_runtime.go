...
import (
	...
	"github.com/vmvarela/ghoten/internal/engine/applying"
	"github.com/vmvarela/ghoten/internal/engine/planning"
	"github.com/vmvarela/ghoten/internal/engine/plugins"
...
// variable GHOTEN_X_EXPERIMENTAL_RUNTIME to any non-empty value.
//
...
// in an experiments-enabled Ghoten build, to make sure that it's not
// possible to accidentally enable this experimental functionality in normal
// release builds.
//
// Refer to "cmd/ghoten/experiments.go" for information on how to produce an
...
func experimentalRuntimeEnabled() bool {
	...
	optIn := os.Getenv("GHOTEN_X_EXPERIMENTAL_RUNTIME")
	return optIn != ""
}
...
// a best effort to shim to Ghoten's current module loader, even though
