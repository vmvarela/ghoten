...
// between Ghoten versions: it's not supported to take an execution graph
// marshaled by one Ghoten version and then try to unmarshal it with a
// different Ghoten version. Even the fact that there is an execution
