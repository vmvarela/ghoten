...
// better meets Ghoten's needs: specifically, it rejects relative filesystem
...
func (e *MaybeRelativePathErr) Error() string {
	return fmt.Sprintf("Ghoten cannot detect a supported external module source type for %s", e.Addr)
}
