...
import (
	...
	"github.com/vmvarela/ghoten/internal/lang/types"
...
func (s *Session) handleHelp() string {
	text := `
The Ghoten console allows you to experiment with Ghoten interpolations.
...
// reminiscent of the Ghoten type constraint syntax that might be used
