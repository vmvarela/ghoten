...
// This file contains some functions representing Ghoten-specific semantic
...
// string representation of some more specific type from elsewhere in Ghoten,
...
// from this codebase so that the rest of Ghoten can use this package without
...
// GhotenProviderAddress returns an attribute definition for indicating
...
func GhotenProviderAddress(addr string) attribute.KeyValue {
	return attribute.String("opentofu.provider.address", addr)
}

// GhotenProviderVersion returns an attribute definition for indicating
...
// [GhotenProviderAddress] to indicate which provider the version number is
// for.
func GhotenProviderVersion(v string) attribute.KeyValue {
	return attribute.String("opentofu.provider.version", v)
}

// GhotenTargetPlatform returns an attribute definition for indicating
// which target platform is relevant to a particular trace span.
//
// The given address should be the result of calling
// [getproviders.Platform.String].
func GhotenTargetPlatform(platform string) attribute.KeyValue {
	return attribute.String("opentofu.target_platform", platform)
}

// GhotenModuleCallName returns an attribute definition for indicating
...
func GhotenModuleCallName(name string) attribute.KeyValue {
	return attribute.String("opentofu.module.name", name)
}

// GhotenModuleSource returns an attribute definition for indicating
...
func GhotenModuleSource(addr string) attribute.KeyValue {
	return attribute.String("opentofu.module.source", addr)
}

// GhotenModuleVersion returns an attribute definition for indicating
...
func GhotenModuleVersion(v string) attribute.KeyValue {
	return attribute.String("opentofu.module.version", v)
}

// GhotenOCIReferenceTag returns an attribute definition for indicating
// which OCI repository tag is relevant to a particular trace span.
func GhotenOCIReferenceTag(name string) attribute.KeyValue {
	return attribute.String("opentofu.oci.reference.tag", name)
}

// GhotenOCIReferenceDigest returns an attribute definition for indicating
// which OCI digest reference is relevant to a particular trace span.
func GhotenOCIReferenceDigest(digest string) attribute.KeyValue {
	return attribute.String("opentofu.oci.reference.digest", digest)
}

// GhotenOCIManifestMediaType returns an attribute definition for indicating
// which OCI manifest media type is relevant to a particular trace span.
func GhotenOCIManifestMediaType(typ string) attribute.KeyValue {
	return attribute.String("opentofu.oci.manifest.media_type", typ)
}

// GhotenOCIManifestArtifactType returns an attribute definition for indicating
// which OCI manifest artifact type is relevant to a particular trace span.
func GhotenOCIManifestArtifactType(typ string) attribute.KeyValue {
	return attribute.String("opentofu.oci.manifest.artifact_type", typ)
}

// GhotenOCIManifestSize returns an attribute definition for indicating
// the size in bytes of an OCI manifest that is relevant to a particular
// trace span.
func GhotenOCIManifestSize(size int64) attribute.KeyValue {
	return attribute.Int64("opentofu.oci.manifest.size", size)
}

// GhotenOCIBlobDigest returns an attribute definition for indicating
// which OCI blob digest is relevant to a particular trace span.
func GhotenOCIBlobDigest(digest string) attribute.KeyValue {
	return attribute.String("opentofu.oci.blob.digest", digest)
}

// GhotenOCIBlobMediaType returns an attribute definition for indicating
// which OCI blob media type is relevant to a particular trace span.
func GhotenOCIBlobMediaType(typ string) attribute.KeyValue {
	return attribute.String("opentofu.oci.blob.media_type", typ)
}

// GhotenOCIBlobArtifactType returns an attribute definition for indicating
// which OCI blob artifact type is relevant to a particular trace span.
func GhotenOCIBlobArtifactType(typ string) attribute.KeyValue {
	return attribute.String("opentofu.oci.blob.artifact_type", typ)
}

// GhotenOCIBlobSize returns an attribute definition for indicating
// the size in bytes of an OCI blob that is relevant to a particular
// trace span.
func GhotenOCIBlobSize(size int64) attribute.KeyValue {
	return attribute.Int64("opentofu.oci.blob.size", size)
}

// GhotenOCIRegistryDomain returns an attribute definition for indicating
// which OCI registry domain name is relevant to a particular trace span.
func GhotenOCIRegistryDomain(domain string) attribute.KeyValue {
	return attribute.String("opentofu.oci.registry.domain", domain)
}

// GhotenOCIRepositoryName returns an attribute definition for indicating
...
// separate attribute built from [GhotenOCIRegistryDomain] for that.
func GhotenOCIRepositoryName(name string) attribute.KeyValue {
