...
type Unconfigured interface {
	...
	// There is a bit of a quirk in Ghoten-land.  We allow providers to supply
	...
	// has received the stop request. Ghoten will not make any further API
...
type ConfigureProviderRequest struct {
	// Ghoten version is the version string from the running instance of
...
type PlanResourceChangeResponse struct {
	...
	// whose type system cannot be precisely mapped into the Ghoten type
...
// ImportedResource represents an object being imported into Ghoten with the
