...
func TestConfigFileConfigDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			files:    []string{filepath.Join(homeDir, ".ghotenrc")},
			expect:   filepath.Join(homeDir, ".ghotenrc"),
		},
		{
		...
		},
		{
			...
			expect:        filepath.Join(homeDir, "xdg", "ghoten", "ghotenrc"),
		},
		{
		...
		},
		{
			...
			testFunc:      cl.configDir,
			xdgConfigHome: filepath.Join(homeDir, "xdg"),
			expect:        filepath.Join(homeDir, "xdg", "ghoten"),
		},
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			expect: []string{
				...
				filepath.Join(homeDir, "xdg", "ghoten"),
			},
		},
		{
			name: "use default",
