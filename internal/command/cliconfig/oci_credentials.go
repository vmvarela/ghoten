...
func discoverAmbientOCICredentials(ctx context.Context, dockerStyleConfigFiles []string, discoEnv ociauthconfig.ConfigDiscoveryEnvironment) ([]ociauthconfig.CredentialsConfig, error) {
	...
	if err != nil {
		...
		// these files are not used exclusively by Ghoten and an anomaly in one of them
		// should never prevent someone from using Ghoten.
...
// https://github.com/vmvarela/ghoten/blob/e0fd3ddd704b230897723a7ca251f36b71c2b67a/config/loader_hcl.go#L1215-L1237
