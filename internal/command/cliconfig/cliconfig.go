...
// variables. The CLI config is not the same thing as a Ghoten configuration
...
//
// This is not the configuration for Ghoten itself. That is in the
// "config" package.
type Config struct {
...
// On Windows, this is the "ghoten.rc" file in the application data
// directory.
...
func (cl *ConfigLoader) LoadConfig(_ context.Context) (*Config, tfdiags.Diagnostics) {
	...
	// files because we're doing something special, like running Ghoten
