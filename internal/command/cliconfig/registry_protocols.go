...
//
// These settings are a little awkward in that they relate to Ghoten's native
...
// we'd extend these settings to any other Ghoten-native registry protocols
...
// backward-compatibility, also partially influence Ghoten's native service
