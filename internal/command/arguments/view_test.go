...
func TestParseView(t *testing.T) {
	testCases := map[string]struct {
		...
		"show all deprecation warnings": {
			...
			&View{ModuleDeprecationWarnLvl: ghoten.DeprecationWarningLevelAll, ConsolidateWarnings: true},
			[]string{},
		},
		"show only local deprecation warnings": {
			[]string{"-deprecation=module:local"},
			&View{ModuleDeprecationWarnLvl: ghoten.DeprecationWarningLevelLocal, ConsolidateWarnings: true},
			[]string{},
		},
		"show no deprecation warnings": {
			[]string{"-deprecation=module:none"},
			&View{ModuleDeprecationWarnLvl: ghoten.DeprecationWarningLevelNone, ConsolidateWarnings: true},
			[]string{},
		},
