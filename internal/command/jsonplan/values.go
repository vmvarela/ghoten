...
func marshalPlannedValues(changes *plans.Changes, schemas *ghoten.Schemas) (Module, error) {
	var ret Module
...
func marshalPlanResources(changeMap map[string]*plans.ResourceInstanceChangeSrc, ris []addrs.AbsResourceInstance, schemas *ghoten.Schemas) ([]Resource, error) {
	var ret []Resource
