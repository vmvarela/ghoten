...
import (
	...
	"github.com/vmvarela/ghoten/internal/command/jsonconfig"
...
// else.
func MarshalResourceChanges(resources []*plans.ResourceInstanceChangeSrc, schemas *ghoten.Schemas) ([]ResourceChange, error) {
...
func (p *Plan) marshalPlannedValues(changes *plans.Changes, schemas *ghoten.Schemas) error {
