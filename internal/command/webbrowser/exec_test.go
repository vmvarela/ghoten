...
const fakeBrowserLaunchCmdOutputEnvName = "GHOTEN_WEBBROWSER_EXEC_TEST_OUTPUT"
...
func TestParseBrowserEnv_esrComplexSpec(t *testing.T) {
	...
	// Ghoten intentionally doesn't support and so should be treated as
	...
	t.Run("multiple commands", func(t *testing.T) {
		...
		// which is the pattern Ghoten supports.
