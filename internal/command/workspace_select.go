...
func (c *WorkspaceSelectCommand) Help() string {
	helpText := `
Usage: ghoten [global options] workspace select [options] NAME

  Select a different Ghoten workspace.

Options:

    -or-create=false    Create the Ghoten workspace if it doesn't exist.
