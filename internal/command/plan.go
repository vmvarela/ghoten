...
// PlanCommand is a Command implementation that compares a Ghoten
...
func (c *PlanCommand) OperationRequest(
	...
	opReq.RefreshMode = args.RefreshMode
...
Plan Customization Options:
  ...
  -refresh-only           Select the "refresh only" planning mode, which checks
                          ...
                          most recent Ghoten apply but does not propose any
                          actions to undo any changes made outside of Ghoten.
...
Other Options:
  ...
  -generate-config-out=path    (Experimental) If import blocks are present in
                               configuration, instructs Ghoten to generate
                               ...
                               Ghoten may still attempt to write
  ...
  -deprecation=module:m        Specify what type of warnings are shown.
                               ...
                               Default: all. When "all" is selected, Ghoten
