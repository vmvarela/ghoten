...
import (
	...
	testing_command "github.com/vmvarela/ghoten/internal/command/testing"
...
func TestTest_DoubleInterrupt(t *testing.T) {
	...
	cleanupMessage := `Ghoten was interrupted while executing main.tftest.hcl, and may not have
...
or when Ghoten specifically suggests to use it as part of an error message.
...
errors or mistakes, or when Ghoten specifically suggests to use it as part of
an error message.
  run "second"... pass
...
// See https://github.com/vmvarela/ghoten/issues/3246
