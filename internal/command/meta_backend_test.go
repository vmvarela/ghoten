...
import (
	...
	"github.com/vmvarela/ghoten/internal/copy"
...
func TestMetaBackend_configuredUnchangedWithStaticEvalVars(t *testing.T) {
	...
	// https://github.com/vmvarela/ghoten/issues/2024
	//
	...
	//    https://github.com/vmvarela/ghoten/issues/2118
	t.Cleanup(
	...
	if diags.HasErrors() {
		// The original problem reported in https://github.com/vmvarela/ghoten/issues/2024
