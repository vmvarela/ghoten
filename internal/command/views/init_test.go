	...
	tests := map[string]struct {
		...
		"fromEmptyDir": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "Ghoten initialized in an empty directory! The directory has no Ghoten configuration files. You may begin working with Ghoten immediately by creating Ghoten configuration files.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("Ghoten initialized in an empty directory!\n\nThe directory has no Ghoten configuration files. You may begin working\nwith Ghoten immediately by creating Ghoten configuration files."),
		},
		"outputNewline": {
			viewCall: func(init Init) {
				init.OutputNewline()
		...
		"initSuccess_non-cloud": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "Ghoten has been successfully initialized!",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("Ghoten has been successfully initialized!"),
		},
		"initSuccessCLI_cloud": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "You may now begin working with cloud backend. Try running \"ghoten plan\" to see any changes that are required for your infrastructure. If you ever set or change modules or Ghoten Settings, run \"ghoten init\" again to reinitialize your working directory.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("\nYou may now begin working with cloud backend. Try running \"ghoten plan\" to\nsee any changes that are required for your infrastructure.\n\nIf you ever set or change modules or Ghoten Settings, run \"ghoten init\"\nagain to reinitialize your working directory."),
		},
		"initSuccessCLI_non-cloud": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "You may now begin working with Ghoten. Try running \"ghoten plan\" to see any changes that are required for your infrastructure. All Ghoten commands should now work. If you ever set or change modules or backend configuration for Ghoten, rerun this command to reinitialize your working directory. If you forget, other commands will detect it and remind you to do so if necessary.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("\nYou may now begin working with Ghoten. Try running \"ghoten plan\" to see\nany changes that are required for your infrastructure. All Ghoten commands\nshould now work.\n\nIf you ever set or change modules or backend configuration for Ghoten,\nrerun this command to reinitialize your working directory. If you forget, other\ncommands will detect it and remind you to do so if necessary."),
		},
		...
		"builtInProviderAvailable": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "terraform is built in to Ghoten",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("- terraform is built in to Ghoten"),
		},
		...
		"lockFileCreated": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "Ghoten has created a lock file .terraform.lock.hcl to record the provider selections it made above. Include this file in your version control repository so that Ghoten can guarantee to make the same selections by default when you run \"ghoten init\" in the future.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("\nGhoten has created a lock file .terraform.lock.hcl to record the provider\nselections it made above. Include this file in your version control repository\nso that Ghoten can guarantee to make the same selections by default when\nyou run \"ghoten init\" in the future."),
		},
		"lockFileChanged": {
			viewCall: func(init Init) {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "Ghoten has made some changes to the provider dependency selections recorded in the .terraform.lock.hcl file. Review those changes and commit them to your version control system if they represent changes you intended to make.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: withNewline("\nGhoten has made some changes to the provider dependency selections recorded\nin the .terraform.lock.hcl file. Review those changes and commit them to your\nversion control system if they represent changes you intended to make."),
		},
		// to stderr
		"configError": {
			viewCall: func(init Init) {
			...
			wantJson: []map[string]any{
				{
					"@level":   "error",
					"@message": "Ghoten encountered problems during initialization, including problems with the configuration, described below. The Ghoten configuration must be valid before initialization so that Ghoten can determine which modules and providers need to be installed.",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: "",
			wantStderr: withNewline("\nGhoten encountered problems during initialization, including problems\nwith the configuration, described below.\n\nThe Ghoten configuration must be valid before initialization so that\nGhoten can determine which modules and providers need to be installed."),
		},
