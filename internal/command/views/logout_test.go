	...
	tests := map[string]struct {
		...
		"logoutSuccess": {
			...
			wantJson: []map[string]any{
				{
					"@level":   "info",
					"@message": "Success! Ghoten has removed the stored API token for app.example.com",
					"@module":  "ghoten.ui",
				},
			},
			wantStdout: "Success! Ghoten has removed the stored API token for app.example.com.\n\n",
		},
		// Diagnostics
		"warning": {
			viewCall: func(logout Logout) {
