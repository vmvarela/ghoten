...
func TestProvisionerPlugin(t *testing.T) {
	...
	tf := e2e.NewBinary(t, ghotenBin, "testdata/provisioner-plugin")
	...
	provisionerExe := e2e.GoBuild("github.com/vmvarela/ghoten/internal/provisioner-local-exec/main", provisionerExePrefix)
