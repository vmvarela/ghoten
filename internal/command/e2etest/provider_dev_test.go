...
func TestProviderDevOverrides(t *testing.T) {
	...
	tf := e2e.NewBinary(t, ghotenBin, "testdata/provider-dev-override")
	...
	providerExe := e2e.GoBuild("github.com/vmvarela/ghoten/internal/provider-simple/main", providerExePrefix)
