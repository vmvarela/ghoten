...
// Package e2etest contains a set of tests that run against a real Ghoten
// binary, compiled on the fly at the start of the test run.
//
// These tests help ensure that key end-to-end Ghoten use-cases are working
...
//
//	go test -v github.com/vmvarela/ghoten/internal/command/e2etest
//
// This will compile on the fly a Ghoten binary and run the tests against
// it.
//
