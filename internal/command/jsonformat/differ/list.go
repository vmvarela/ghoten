...
import (
	"github.com/vmvarela/ghoten/internal/command/jsonformat/collections"
	...
	"github.com/vmvarela/ghoten/internal/command/jsonformat/jsondiff"
...
func computeAttributeDiffAsList(change structured.Change, elementType cty.Type) computed.Diff {
	...
	processIndices := func(beforeIx, afterIx int) computed.Diff {
		...
		// relevant.
		//
		// Interestingly the ghoten plan builder also agrees with this, and
