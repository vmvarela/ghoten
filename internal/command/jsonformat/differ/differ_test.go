...
func TestValue_SimpleBlocks(t *testing.T) {
	...
	tcs := map[string]struct {
		...
		// Before the fix for https://github.com/vmvarela/ghoten/issues/3640, this test was failing randomnly.
...
func TestSpecificCases(t *testing.T) {
	...
	tcs := map[string]struct {
		...
		// The following tests are from issue 33472. Basically Ghoten allows
		...
		// Following tests are from issue 1805. https://github.com/vmvarela/ghoten/issues/1805.
