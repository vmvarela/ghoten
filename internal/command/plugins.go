...
import (
	...
	fileprovisioner "github.com/vmvarela/ghoten/internal/builtin/provisioners/file"
	localexec "github.com/vmvarela/ghoten/internal/builtin/provisioners/local-exec"
	remoteexec "github.com/vmvarela/ghoten/internal/builtin/provisioners/remote-exec"
	"github.com/vmvarela/ghoten/internal/logging"
	tfplugin "github.com/vmvarela/ghoten/internal/plugin"
	"github.com/vmvarela/ghoten/internal/plugin/discovery"
...
func (m *Meta) pluginDirs(includeAutoInstalled bool) []string {
	...
	// Look in the same directory as the Ghoten executable.
