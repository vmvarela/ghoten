...
// multiple Ghoten processes from reading and writing state concurrently.
...
type LockInfo struct {
	...
	// Ghoten operation, provided by the caller.
...
func NewLockInfo() *LockInfo {
	...
	// Use a uuid format to match other IDs used throughout Ghoten.
	buf := make([]byte, 16)
	rngSource.Read(buf)
