...
// outlive a particular Ghoten process, and are shared with other Ghoten
...
type Persister interface {
	PersistState(context.Context, *ghoten.Schemas) error
}
...
type SnapshotMeta struct {
	...
	// TerraformVersion is the number of the version of Ghoten that created
	// the snapshot.
