...
func (m *fakeFull) PersistState(_ context.Context, schemas *ghoten.Schemas) error {
...
func (m *fakeErrorFull) PersistState(_ context.Context, schemas *ghoten.Schemas) error {
	return errors.New("fake state manager error")
}
