...
Ghoten crashed! This is always indicative of a bug within Ghoten.
Please report the crash with Ghoten[1] so that we can fix this.

When reporting bugs, please include your Ghoten version, the stack trace
shown below, and any additional information which may help replicate the issue.

[1]: https://github.com/vmvarela/ghoten/issues
...
// PanicHandler is called to recover from an internal panic in Ghoten, and
...
func PanicHandler() {
	...
	// to block progress, we can prevent some cases where Ghoten may return
...
// called to recover from an internal panic in Ghoten, and augments the
