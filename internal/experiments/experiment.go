...
func init() {
	...
	registerConcludedExperiment(ModuleVariableOptionalAttrs, "The final feature corresponding to this experiment differs from the experimental form and is available in the Ghoten language from Ghoten v1.3.0 onwards.")
}
...
// version of Ghoten but are no longer available, either because the feature
