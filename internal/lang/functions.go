...
import (
	...
	"github.com/vmvarela/ghoten/internal/lang/funcs"
)
...
func (s *Scope) Functions() map[string]function.Function {
	...
	if s.funcs == nil {
		...
		if s.ConsoleMode {
			// The type function is only available in Ghoten console.
			s.funcs["type"] = funcs.TypeFunc
		} else {
			// The plantimestamp function doesn't make sense in the Ghoten
			// console.
