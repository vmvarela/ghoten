...
var TextEncodeBase64Func = function.New(&function.Spec{
	...
	Impl: func(args []cty.Value, retType cty.Type) (cty.Value, error) {
		...
		if err != nil || encoding == nil {
			return cty.UnknownVal(cty.String), function.NewArgErrorf(1, "%q is not a supported IANA encoding name or alias in this Ghoten version", args[1].AsString())
		}
...
//
// Ghoten uses the "standard" Base64 alphabet as defined in RFC 4648 section 4.
//
// Strings in the Ghoten language are sequences of unicode characters rather
