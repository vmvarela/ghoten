...
// resource instances are our atomic unit of change as far as Ghoten core
// is concerned.
...
// system, and so is ready to be sent to other parts of Ghoten that aren't
...
// of the Ghoten codebase, because [ResourceInstanceMark] is an implementation
