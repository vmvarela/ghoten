...
// first edition of the Ghoten language, established with Ghoten v1.6
...
// between blocks and expressions in an Ghoten module that is written for
...
import (
	_ "github.com/vmvarela/ghoten/internal/configs"
)
...
//   maybe we'll replace with some Ghoten-specific wrapper types in future.
