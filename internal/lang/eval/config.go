...
// module language itself, such as running an Ghoten CLI command.
...
// of the Ghoten language (which is called "tofu2024" in this set of packages)
...
func PrepareTofu2024Module(sourceAddr addrs.ModuleSource, mod *configs.Module) UncompiledModule {
	return ghoten2024.NewUncompiledModule(sourceAddr, mod)
}
