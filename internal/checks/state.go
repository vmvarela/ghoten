...
// a particular Ghoten configuration and their current statuses.
//
...
// how many checkable objects will be dynamically-declared yet. Ghoten Core
...
type configCheckableState struct {
	...
	// once Ghoten Core reports the expansion of this configuration
	// construct.
	//
	// The leaf Status values will initially be StatusUnknown
	// and then gradually updated by Ghoten Core as it visits the
...
//
// The given address must refer to a checkable object that Ghoten Core
