...
//
// Point 2 is a bit complicated so worth expanding on. In normal Ghoten
...
// identified to the user but not to fail the actual Ghoten operation. During
...
// diagnostics were generated by custom conditions. Ghoten adds the
