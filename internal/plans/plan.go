...
type Plan struct {
	...
	// Ghoten operation, without any updates from the remote system but
	...
	//
	// This is never recorded outside of Ghoten. It is not written into the
	...
	// Ghoten testing framework, and so isn't written into any external
...
// should indicate that there's nothing to do and Ghoten should exit
...
func (p *Plan) CanApply() bool {
	...
	case !p.PriorState.ManagedResourcesEqual(p.PrevRunState):
		...
		// outside-Ghoten changes while refreshing then we consider
