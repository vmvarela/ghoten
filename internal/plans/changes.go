...
// Changes describes various actions that Ghoten will attempt to take if
...
type ResourceInstanceChange struct {
	...
	// Ghoten that relates to this change. Ghoten will save this
...
// a normal apply or a destroy. This flag deals with the fact that Ghoten
