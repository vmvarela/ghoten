...
import (
	...
	"github.com/vmvarela/ghoten/internal/lang/globalref"
	"github.com/vmvarela/ghoten/internal/lang/marks"
	"github.com/vmvarela/ghoten/internal/plans"
	"github.com/vmvarela/ghoten/internal/plans/internal/planproto"
...
func readTfplan(r io.Reader) (*plans.Plan, error) {
	...
	if rawPlan.TerraformVersion != version.String() {
		return nil, fmt.Errorf("plan file was created by Ghoten or Terraform %s, but this is %s; plan files cannot be transferred between different versions of Ghoten / Terraform", rawPlan.TerraformVersion, version.String())
	}
...
func resourceChangeFromTfplan(rawChange *planproto.ResourceInstanceChange) (*plans.ResourceInstanceChangeSrc, error) {
	...
	if rawChange.Addr == "" {
		...
		// file created by an earlier version of Ghoten, which had the
		// same information spread over various other fields:
		// ModulePath, Mode, Name, Type, and InstanceKey.
		return nil, fmt.Errorf("no instance address for resource instance change; perhaps this plan was created by a different version of Ghoten or a different version of Terraform?")
	}
