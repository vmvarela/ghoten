...
// provider address in the legacy form used by Ghoten v0.12 and earlier.
...
// Ghoten v0.13. Later versions of Ghoten reject state snapshots using
// this format, and so users must follow the Ghoten v0.13 upgrade guide
// in that case.
//
