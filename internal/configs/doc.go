...
// Package configs contains types that represent Ghoten configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// Ghoten configurations, but this package generally exposes representations
...
// diagnostics can be converted into Ghoten-flavored diagnostics, if needed,
