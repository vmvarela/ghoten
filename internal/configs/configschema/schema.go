...
// directly onto the physical block syntax of Ghoten's native configuration
...
type Attribute struct {
	...
	// future to help Ghoten mask sensitive information. (Ghoten
	...
	// the provider, and an error will be returned if Ghoten detects such a thing.
	WriteOnly bool
}
