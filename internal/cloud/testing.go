...
// mockInput is a mock implementation of ghoten.UIInput.
type mockInput struct {
	answers map[string]string
}

func (m *mockInput) Input(ctx context.Context, opts *ghoten.InputOpts) (string, error) {
...
func (v *unparsedVariableValue) ParseVariableValue(mode configs.VariableParsingMode) (*ghoten.InputValue, tfdiags.Diagnostics) {
...
func testVariables(s ghoten.ValueSourceType, vs ...string) map[string]backend.UnparsedVariableValue {
