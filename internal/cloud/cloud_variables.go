...
func allowedSourceType(source ghoten.ValueSourceType) bool {
	return source == ghoten.ValueFromNamedFile || source == ghoten.ValueFromCLIArg || source == ghoten.ValueFromEnvVar
}
