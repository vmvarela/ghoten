...
const ignoreRemoteVersionHelp = "If you're sure you want to upgrade the state, you can force Ghoten to continue using the -ignore-remote-version flag. This may result in an unusable workspace."
