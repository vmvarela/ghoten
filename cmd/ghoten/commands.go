...
// that assume that Ghoten is being run from a command prompt.
const runningInAutomationEnvName = "TF_IN_AUTOMATION"

// commands is the mapping of all the available Ghoten commands.
...
func initCommands(
	...
	meta := command.Meta{
		...
		// use of the Ghoten configuration files. Therefore, there is no way to configure
